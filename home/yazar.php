...
<html lang="tr">
<head>
<title><?=$yazarara ?> tarafından yazılan haberler | <?=$sitebilgi['title'];?></title>
<?php include "../sayfalar/header.php"; ?>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="section-title">
						<h1><?=$yazarara ?> tarafından yazılan haberler</h1>
	...
	<section id="blog">
		<div class="container">
			<div class="row">
				 <div class="col-md-9">			
			<?php if($sorgular->rowCount() != "0"){ // Aranan kelimeye göre veri varsa
	foreach($sorgucek as $row){  ?>
		<div class="col-md-6">
