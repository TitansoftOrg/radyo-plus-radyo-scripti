...
(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        startTemplate: 'minimized', // Start minimized or maximized on load @string
        ...
        language: {
            offlineText: 'Radyo Çevrimdışı', // On offline: status bar text @string
            playedText: 'Müzik geçmişi', // Played title (player bottom) @string
            unknownTrackText: 'Bilinmeyen şarkı - c^o^d^e^l^i^s^t^.^c^c', // Set unknown track text when error
            unknownArtistText: 'Bilinmeyen şarkıcı' // Set unknown artist text when error
